...
import type { BracingNode } from '@pascal-app/core'
...
interface BracingTreeNodeProps {
  node: BracingNode
  depth: number
  isLast?: boolean
}

export function BracingTreeNode({ node, depth, isLast }: BracingTreeNodeProps) {
