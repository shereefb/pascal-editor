...
import type { HeaderNode } from '@pascal-app/core'
...
interface HeaderTreeNodeProps {
  node: HeaderNode
  depth: number
  isLast?: boolean
}

export function HeaderTreeNode({ node, depth, isLast }: HeaderTreeNodeProps) {
