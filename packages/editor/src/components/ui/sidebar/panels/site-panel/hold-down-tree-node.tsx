...
import type { HoldDownNode } from '@pascal-app/core'
...
interface HoldDownTreeNodeProps {
  node: HoldDownNode
  depth: number
  isLast?: boolean
}

export function HoldDownTreeNode({ node, depth, isLast }: HoldDownTreeNodeProps) {
