...
import type { JoistNode } from '@pascal-app/core'
...
interface JoistTreeNodeProps {
  node: JoistNode
  depth: number
  isLast?: boolean
}

export function JoistTreeNode({ node, depth, isLast }: JoistTreeNodeProps) {
